  ...
  return (
    <section className="container grid items-center gap-6 pb-8 pt-6 md:py-10">
      <div className="flex max-w-[980px] flex-col items-start gap-2">
        <h1 className="py-2 text-3xl font-extrabold leading-tight tracking-tighter md:py-4 md:text-4xl">
      ...
      <div className="flex flex-col gap-4 py-2 md:flex-row md:py-4">
        <Link
